...
INSERT INTO table_tennis_analysis (
    videoId, frameId, frameAction, tablex1, tabley1, tablex2, tabley2, tablex3, tabley3, tablex4, tabley4, ballx, bally, ballz, depthMapPath, player1x, player1y, player1z, player2x, player2y, player2z
)
VALUES
    (1, 101, 'serve', 12.2, 8.4, 13.1, 8.5, 13.2, 9.2, 12.1, 9.1, 6.5, 7.2, 0.9, 'https://www.paralympic.org/sites/default/files/styles/large_original/public/images/150413103127066_LON_0109_4685.jpg?itok=rgvvqm0F', 7.9, 2.1, 0.8, 7.9, 2.1, 0.8);
...
VALUES
    (1, 101, 'serve', 12.2, 8.4, 13.1, 8.5, 13.2, 9.2, 12.1, 9.1, 6.5, 7.2, 0.9, 'https://www.paralympic.org/sites/default/files/styles/large_original/public/images/150413103127066_LON_0109_4685.jpg?itok=rgvvqm0F');

INSERT INTO table_tennis_analysis (
    videoId, frameId, frameAction, tablex1, tabley1, tablex2, tabley2, tablex3, tabley3, tablex4, tabley4, ballx, bally, ballz, depthMapPath
)
VALUES
    (1, 102, 'rally', 12.3, 8.5, 13.0, 8.6, 13.0, 9.0, 12.0, 9.0, 6.6, 7.1, 0.95, 'https://www.paralympic.org/sites/default/files/styles/large_original/public/images/150413103127066_LON_0109_4685.jpg?itok=rgvvqm0F');

INSERT INTO table_tennis_analysis (
    videoId, frameId, frameAction, tablex1, tabley1, tablex2, tabley2, tablex3, tabley3, tablex4, tabley4, ballx, bally, ballz, depthMapPath
)
VALUES
    (1, 103, 'rally', 12.3, 8.5, 13.0, 8.6, 13.0, 9.0, 12.0, 9.0, 6.6, 7.1, 0.95, 'https://www.paralympic.org/sites/default/files/styles/large_original/public/images/150413103127066_LON_0109_4685.jpg?itok=rgvvqm0F');
