#!/usr/bin/env python3
"""
Table Tennis Table Detection Program by Perplexity
Too much verbose, but works to some extent.
"""
...
def main(image_path):
    ...
    if vertices and midpoint:
        ...
        helper.plotpoints(image_path, vertices+[midpoint], point_color=(0, 255, 0), radius=10)
